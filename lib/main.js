...
state.blocks = [
                // Tutorial
                block(1,8.5,5,.5,'C'), block(6,8.5,13,0.5),block(0,0,35,.5),
                block(19,8.5,4,0.5,'C'), block(23,8.5,2,0.5), block(25,8.5,10,0.5,'D'), block(36,3.5,4,0.5, 'R'),
                
                block(0,0.5,1,8.5), block(7,7.5,1,1),
                block(11,5.5,1,3), block(14,0.5,1,5, 'D'),
                block(17,3,1,5.5), block(35,3.5,1,5.5),
              
                // Shaft
                block(35,-11,1,11.5), block(40,-4,1,8),
                block(34,-28,1,17.5), block(41,-18,1,15),
                block(35,-28,10,1),
                
                // Lava
                block(42,-18,3,0.5, 'C'), block(45,-18,1,4), block(46,-15,50,1,'D'), block(96,-17,5,3), block(101,-15,30,1,'D'),
                block(65.5,-18,3,1), block(76.5,-18,5,1), block(91,-18,6,1), block(97,-18,3,1,'C'), block(100,-18,6,1),block(125,-16,5,0.5), 
                block(45,-34,1,7), block(46,-34,22,1), block(68,-33,1,12), block(69 ,-22,60,1,'D'),
                block(55,-25,1,10, 'D'),
